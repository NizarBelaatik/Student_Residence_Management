...
<body >
    ...
    <header>
        <div class="left-tabs">
            ...
            <button class="tab-button">Settings</a>
        </div>
                    ...
                    <ul class="dropdown-notifications">
                        ...
                        <li class="notification-item">
                            ...
                            <div class="notification-content">
                                ...
                                <p>There is a new system update availableThere is a new system update availableThere is a new system update availableThere is a new system update available.</p>
                            </div>
                        </li>
