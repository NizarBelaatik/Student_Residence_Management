            ...
            <div class="col-lg-10">
                ...
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item"><strong>Email:</strong> ${techD.getEmail()}</li>
                            <li class="list-group-item"><strong>First name:</strong> ${techD.getFirstname()}</li>
                            <li class="list-group-item"><strong>Last name:</strong> ${tech.getLastname()}</li>
                            <li class="list-group-item"><strong>Phone:</strong> ${techD.getPhone()}</li>
                        </ul>
